    ...
    <body>
        <div class="container">
           <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/">Contacts List</a></h3>
            ...
            <li><button type="button" id="create_csv" class="btn btn-default navbar-btn"> Create CSV</button></li>
            <li><button type="button" id="scan_csv" class="btn btn-default navbar-btn">Scan CSV</button> </li>
        </div>
